...
import AvatarImage from 'public/assets/headerImage.jpg';

const biography = [
  "Hi, I'm Andrea Cavagna. I'm a Produxct manager by day and a developer by night. I love giving the best Developer and User experience possible while I automate everything.",
  "Hi, I'm Andrea Cavagna. I'm a Produxct manager by day and a developer by night. I love giving the best Developer and User experience possible while I automate everything. I'm an ex-basketball coach and I love speaking about cybersecurity, leadership and team management.",
  'Andrea Cavagna is a Product Manager who is still love to code in the weekends. He lives in Italy with his cat Melo.',
  'Andrea Cavagna is a Product Manager who is still love to code in the weekends. He lives in Italy with his cat Melo. He love to automate most of his task to give developers the best Developer Experience possible.'
];
...
export default function Talks({ talks }) {
  ...
  return (
    <Container title="Talks - Andrea Cavagna">
      <h1>
